...
public class EditCoverPictureActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_cover_picture);
        ...
        imageCover.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (ContextCompat.checkSelfPermission(EditCoverPictureActivity.this,
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton(getString(R.string.button_allow_dialog_permission_not_accepted), new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ActivityCompat.requestPermissions(EditCoverPictureActivity.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, 1);
                        }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        try {
            uri = data.getData();
            Picasso.get().load(uri).into(imageCover);
