...
public class FollowersUserRecyclerAdapter extends RecyclerView.Adapter<FollowersUserRecyclerAdapter.ViewHolder> {
    Context context;
    ...
    public FollowersUserRecyclerAdapter(Context context, ArrayList<FollowersItem> followersItemArrayList) {
        this.context = context;
        this.followersItemArrayList = followersItemArrayList;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("uid", followersItemArrayList.get(position).getUser());
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        for (DocumentSnapshot snapshot : Objects.requireNonNull(task.getResult())) {
                            ...
                            if (usersItem.getUid().equals(followersItemArrayList.get(position).getUser())) {
    ...
    public int getItemCount() {
        return followersItemArrayList.size();
    }
